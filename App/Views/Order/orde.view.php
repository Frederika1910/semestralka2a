...
<div class="container">
                        ...
                        <div class="list-group">
                            <div style="height: 180px; overflow-y: auto; overflow-x: hidden;">
                                <div class="row" style="align-content: center">
                                    ...
                                    <button type="button" id="orders_filter_butMob" class="btn btn-primary orders_filter_but" style="background-color:  #8B0000; align-self: flex-end">Potvrdiť</button>
                                </div>
                            </div>
                        </div>
                <?php } ?>
    ...
    <?php if (\App\Auth::isLogged() && \App\Auth::isAdmin()) { ?>
        <div class="row rBBigScreen" style="align-content: center">
            ...
            <div class="col-md-3 col-sm-12">
                <button type="button" id="orders_filter_but" class="btn btn-primary orders_filter_but" style="background-color:  #8B0000; align-self: flex-end">Potvrdiť</button>
            </div>
        </div>
    <?php } ?>
                ...
                <tr class="sendItem<?php echo $order->getId()?>">
                    ...
                    <td>
                        <?php if ($order->getState() == 1) { ?>
                            <button type="button" id="stornoBut<?php echo $order->getId() ?>" class="btn btn-danger delOrderBut" data-id="<?php echo $order->getId() ?>"><i class="bi bi-trash"></i>
                        ...
                        <?php } else { ?>
                            <button type="button" class="btn btn-danger" disabled><i class="bi bi-trash"></i>
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
                                    <path d="M5.5 5.5A.5.5 0 0 1 6 6v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm2.5 0a.5.5 0 0 1 .5.5v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm3 .5a.5.5 0 0 0-1 0v6a.5.5 0 0 0 1 0V6z"/>
                                    <path fill-rule="evenodd" d="M14.5 3a1 1 0 0 1-1 1H13v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V4h-.5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1H6a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1h3.5a1 1 0 0 1 1 1v1zM4.118 4 4 4.059V13a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4.059L11.882 4H4.118zM2.5 3V2h11v1h-11z"/>
                                </svg>
