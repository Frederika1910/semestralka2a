...
<div class="container">
                ...
                <?php if (\App\Auth::isLogged() && \App\Auth::isAdmin()) { ?>
                        <div class="list-group">
                            <div style="height: 180px; overflow-y: auto; overflow-x: hidden;">
                                <div class="row" style="align-contentt: center">
                                    <div class="list-group-item checkbox">
                                        <label><input type="radio" name="radiobuttonOrder" class="common_selector order" value="1" autocomplete="off">Na odoslanie</label>
                                    </div>
                                    <div class="list-group-item checkbox">
                                        <label><input type="radio" name="radiobuttonOrder" class="common_selector order" value="3" autocomplete="off">Na stornovanie</label>
                                    </div>
                                    <div class="list-group-item checkbox">
    ...
    <?php if (\App\Auth::isLogged() && \App\Auth::isAdmin()) { ?>
        <div class="row rBBigScreen" style="align-contentt: center">
            ...
            if ($order->getUserId() == $currentUser) { ?>
                <tr class="sendItem<?php echo $order->getId()?>">
                    ...
                    <td>
                        ...
                        <?php } else { ?>
                            <button type="submit" id="stornoBut<?php echo $order->getId() ?>" class="btn btn-danger delOrderBut" disabled="true" dataId="<?php echo $order->getId() ?>""><i class="bi bi-trash"></i>
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
                                    <path d="M5.5 5.5A.5.5 0 0 1 6 6v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm2.5 0a.5.5 0 0 1 .5.5v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm3 .5a.5.5 0 0 0-1 0v6a.5.5 0 0 0 1 0V6z"/>
                                    <path fill-rule="evenodd" d="M14.5 3a1 1 0 0 1-1 1H13v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V4h-.5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1H6a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1h3.5a1 1 0 0 1 1 1v1zM4.118 4 4 4.059V13a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4.059L11.882 4H4.118zM2.5 3V2h11v1h-11z"/>
                                </svg>
